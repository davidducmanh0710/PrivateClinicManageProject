...
public class SpringSecurityConfig {
	...
	private ClientRegistration githubClientRegistration() {
		return CommonOAuth2Provider.GITHUB.getBuilder("github").clientId("Iv23li9c2DBQdPPfGsS4")
				.clientSecret("635467d0f99416ca366656f73b42db66390f2302").build();
	}

	private ClientRegistration googleClientRegistration() {
		return CommonOAuth2Provider.GOOGLE.getBuilder("google").scope("email", "profile")
				.clientId(
						"990297844611-iehm3m7kr73hap6e02dinnr0bl0jh1r9.apps.googleusercontent.com")
				.clientSecret("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").build();
	}
